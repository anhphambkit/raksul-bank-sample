...
**Reviewer path:** [watch the demo](https://github.com/anhphambkit/raksul-bank-sample/raw/refs/heads/main/docs/assets/raksul-bank-demo.mp4) · [run locally](#getting-started) · [architecture](#architecture-overview) · [acceptance evidence](docs/verification.md)
